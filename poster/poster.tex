...
\makeextracolumn{
    ...
    \includegraphics[width=0.9\linewidth,draft]{./images/design.png}
    \linebreak
    \includegraphics[width=0.9\linewidth,draft]{./images/print.png}
    \linebreak
    \includegraphics[width=0.9\linewidth,draft]{./images/build.png}
