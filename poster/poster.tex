...
\makemain{
    ...
    \begin{multicols}{2}
        ...
        \setlength\itemsep{0.1em}
            ...
            \item Attach one of the mirrors to a sample holder, as it expands or contrats the interference pattern will phase shift.
    ...
    \columnbreak
        ...
        \setlength\itemsep{0.1em}
            ...
            \item High heat will start to deform the sample holder.
